...
public class HW1 {
  ...
  public static void main(String[] args) {
    ...
    Deque<String> list_2 = new LinkedList<>(Arrays.asList("8", "2", "-"));
    ...
    // Преобразуем списки в числа типа int и перемножаем числа:
    ...
    // Создаём результирующие списки:
    System.out.println();
    System.out.println("Результирующие списки: ");
